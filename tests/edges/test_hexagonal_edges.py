...
class TestTriIcosahedralEdgesInit:
    ...
    def test_fail_init(self, xhops: int):
        """Test HexagonalEdges initialization with invalid xhops."""
        with pytest.raises(AssertionError):
            HexagonalEdges("test_nodes", "test_nodes", xhops)
...
class TestTriIcosahedralEdgesTransform:
    ...
    def ico_graph(self) -> HeteroData:
        ...
        graph = HeteroData()
        graph = HexagonalNodes(0, "test_nodes").update_graph(graph, {})
